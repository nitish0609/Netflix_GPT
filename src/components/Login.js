  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-11/12 md:w-3/5 lg:w-2/5 xl:w-2/6 absolute p-4 md:p-12 my-36 mx-auto right-0 left-0 bg-black text-white rounded-lg bg-opacity-80 flex flex-col items-center justify-center md:my-20"
      >
